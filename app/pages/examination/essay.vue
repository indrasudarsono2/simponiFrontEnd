...
async function postMonitoringSnapshot(
  ...
  formData.append(
    ...
    cameraBlob,
    screenMonitoringEnabled
      ? `essay-camera-${currentEventId}-${currentGroupMemberId}-m${targetMinute}.jpg`
  ...
  if (screenBlob) {
    formData.append(
      "screenFile",
      screenBlob,
      `essay-screen-${currentEventId}-${currentGroupMemberId}-m${targetMinute}.jpg`,
    );
  }
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
                ...
                <div class="rounded-xl border border-default p-3 bg-muted/20">
                  <div class="flex items-center justify-between gap-2 mb-2">
                    ...
                    <div class="flex gap-1">
                      ...
                      <UBadge
                        ...
                        :label="
                          isScreenReady ? 'Screen Active' : 'Screen Inactive'
                        "
                      />
                    </div>
                  </div>
                  ...
                  <p
                    v-else-if="isCameraObstructed"
                    class="text-xs text-warning mt-2"
                  >
                    Camera looks obstructed (too dark/covered). Please adjust
                    camera.
                  </p>
                  <p
