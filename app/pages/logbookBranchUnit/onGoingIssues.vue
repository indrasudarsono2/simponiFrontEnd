  ...
  try {
    ...
    toast.add({
      ...
      description:
        ...
        error?.message ||
        "Failed to load On Going Issue recap.",
      color: "error",
    });
  } finally {
    loading.value = false;
...
function downloadCsv() {
  ...
  link.href = url;
  link.download = `on-going-issue-recap-${safeFilePart(startDate.value)}-to-${safeFilePart(endDate.value)}.csv`;
...
<template>
  <UDashboardPanel id="on-going-issue-recap">
    <template #header>
    ...
    <template #body>
      <div class="space-y-4 p-4 sm:p-6">
          ...
          <template #header>
            <div class="flex flex-col gap-1">
              ...
              <p class="text-sm text-muted">
                Load On Going Issue data by start date.
              </p>
            </div>
          </template>
        ...
        <UCard>
          ...
          >
            Select date range and click Load Data to show On Going Issue recap.
          </div>
            ...
            <table class="min-w-full border-collapse text-sm">
              ...
              <tbody>
                <tr v-for="(issue, index) in issues" :key="issue.id">
                  ...
                  <td
                    class="border border-default px-4 py-3 align-top whitespace-pre-wrap"
                  >
                    {{ issue.other || "-" }}
                  </td>
                  <td class="border border-default px-4 py-3 align-top">
