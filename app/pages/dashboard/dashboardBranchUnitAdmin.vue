...
<template>
  <UDashboardPanel id="dashboard-branch-unit-admin">
    <template #header>
      <UDashboardNavbar title="Branch Unit Admin Dashboard">
        <template #leading>
            ...
            <template #header>
              <div class="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p class="text-sm text-muted">
                    Operational issues from the last month for your branch unit.
                  </p>
                </div>
                <UBadge
