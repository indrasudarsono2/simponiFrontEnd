...
watch(
  ...
  (room) => {
    ...
    formState.startDate = room.startDate || "";
    ...
    if (formState.file) {
      ...
      await $fetch(`http://${ip.ipBackEnd}/api/room/${props.room.id}`, {
        ...
        body: {
          ...
          eventUsersId: formState.eventUsersId,
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-lg border border-default bg-elevated/40 p-3 space-y-2">
          ...
          <div class="text-xs space-y-1 text-muted">
            ...
            <p><span class="font-medium">Assign User:</span></p>
            <ul
            ...
            <p>
              ...
              {{ formState.file?.name || "Keep existing file" }}
            </p>
          </div>
        </div>
      </div>
